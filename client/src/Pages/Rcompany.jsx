...
const validationsForm =(form)=>{
    ...
    let expTel = /^([0-9]{10})$/;
    let expCorreo = /^([a-zA-Z0-9ñáéíóúÑÁÉÍÓÚ.!#$%&'*+=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:.[a-zA-Z0-9-]+)+)$/;
    let espPass = /^.{8}$/;
    let espTex = /^.{1,255}$/;
...
const SignUp = () => {
    const{form, errors, loading, response,handleChange,handleBlur,handleSubmit}= val_company(initialForm, validationsForm);
                        ...
                        <div className="d-flex">
                            ...
                            <div className="col-sm-12 col-md-12 col-lg-6 col-xl-6 bgf px-5 py-5">
                                ...
                                <div className="mb-3 mt-5 justify-content-center">
                                    ...
                                    <input type="reset" className="btn btn-primary" value="Limpiar"/>
