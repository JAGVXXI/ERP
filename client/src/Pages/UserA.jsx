...
export const UserA = () => {
    ...
    const getUsers = async () => {
        try {
          const res = await axios.get("http://localhost:5000/us/company", { withCredentials: true });
          //console.log("hola");
          
            const res2 = await axios.get(`http://localhost:5000/api/user/RRHH/${res.data.idd}`)
            setRRHH(res2.data)
...
<div className="PLogin">
    ...
    <div className="container  py-5" id="conPrin">
        ...
        <div>
            <p>Ahun no Estas Dentro de una empresa</p>

            <p>Asociar empresa existente:</p>
            <form action="">
            <select id="company" name="company" class="form-select">
                {Array.isArray(companys) && companys.map((company) => (
